...
if (!process.env.POSTHOG_PROJECT_API_KEY)
  throw new Error('Missing required environment variable "POSTHOG_PROJECT_API_KEY".');
...
export default async function forwardTelemetry(req: NextApiRequest, res: NextApiResponse) {
  if (req.method !== 'POST') {
